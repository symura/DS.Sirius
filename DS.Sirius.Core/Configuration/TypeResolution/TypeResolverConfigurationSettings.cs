...
namespace DS.Sirius.Core.Configuration.TypeResolution
{
    ...
    public class TypeResolverConfigurationSettings : ConfigurationSettingsBase
    {
        ...
        /// </summary>
        public TypeResolverConfigurationSettings() : base(ROOT)
        {
        ...
        public TypeResolverConfigurationSettings(IEnumerable<string> asmList, IEnumerable<string> nsList): this()
        {
        ...
        public TypeResolverConfigurationSettings(XElement element) : this()
        {
            ReadFromXml(element);    
        }
